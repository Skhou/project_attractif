 ...
 * @ORM\Entity(repositoryClass="Ip\AttractifBundle\Repository\CategoryRepository")
 */
class Category
{
    /**
     ...
     * @var string
     *
     * @ORM\OneToMany(targetEntity="Ip\AttractifBundle\Entity\Product", mappedBy="category")
     */
    private $products;
